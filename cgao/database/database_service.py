...
class DatabaseService:
    ...
    def save_author(self, result: DetailResult):
    ...
    def save_post(self, result: DetailResult):
    ...
    def save_images(self, result: DetailResult):
    ...
    def save_tags(self, result: DetailResult):
